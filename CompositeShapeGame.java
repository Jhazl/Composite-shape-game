...
public class CompositeShapeGame extends JFrame {
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new CompositeShapeGame();
			}
		});
	}
	public CompositeShapeGame() {
	...
	class AddListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if(selectedNode == null){
				...
				NestedShape nodeToInsert = ((NestedShape) selectedNode);
				panel.model.addShapeNode(nodeToInsert);
			}
		}
	}
	...
	class RemoveListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if(selectedNode == null){
				JOptionPane.showMessageDialog(null, "ERROR: No node selected."); 
			}else if(selectedNode.equals(panel.model.getRoot())){
				JOptionPane.showMessageDialog(null, "ERROR: Must not remove the root.");
			}else{
				Shape nodeToRemove = ((Shape) selectedNode);
				panel.model.removeNodeFromParent(nodeToRemove);
			}
		}
	}
    ...
    public void valueChanged(TreeSelectionEvent e){
        Object componentSelected = tree.getLastSelectedPathComponent();
        if(componentSelected instanceof NestedShape){
           panel.model.reload(((NestedShape) componentSelected));	
		}
      }
	}
	...
	public JPanel setUpToolsPanel() {
		...
		widthTextField = new JTextField("Enter width here: e.g. " + Shape.DEFAULT_WIDTH, 5);
		widthTextField.addActionListener( new WidthActionListener());
		heightTextField = new JTextField("Enter height here: e.g. " + Shape.DEFAULT_HEIGHT, 5);
